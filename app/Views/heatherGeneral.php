<heather>
    ...
    <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
        ...
        <div class="hidden md:flex items-center gap-6 font-semibold">
            ...
            <a href="<?= BASE_URL ?>/publicaciones" class="hover:underline underline-offset-4"> Publicaciones </a>
    ...
    <div class="md:hidden bg-superarse-morado-medio px-4 py-2 flex flex-wrap justify-center gap-4 text-sm font-semibold">
        <a href="<?= BASE_URL ?>/libros/catalogo" class="hover:underline">Libros</a>
        <a href="<?= BASE_URL ?>/tesis" class="hover:underline">Tesis</a>
        <a href="<?= BASE_URL ?>/publicaciones" class="underline underline-offset-4">
            Publicaciones
        </a>
    </div>
</nav>
